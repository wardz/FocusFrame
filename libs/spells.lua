	...
	SPELLINFO_TRADECASTS_TO_TRACK = SPELLINFO_TRADECASTS_TO_TRACK or {
		-- MISC
	...
	SPELLINFO_SPELLCASTS_TO_TRACK = SPELLINFO_SPELLCASTS_TO_TRACK or {
			-- MISC & MOB SPELLS
...
--        ['Evocation']               = {[[Interf ace\Icons\Spell_nature_purge]], 8},
	...
	SPELLINFO_CHANNELED_HEALS_SPELLCASTS_TO_TRACK = SPELLINFO_CHANNELED_HEALS_SPELLCASTS_TO_TRACK or {
		-- DRUID
	...
	SPELLINFO_CHANNELED_SPELLCASTS_TO_TRACK = SPELLINFO_CHANNELED_SPELLCASTS_TO_TRACK or {
		-- MISC
		...
		SPELLINFO_INSTANT_SPELLCASTS_TO_TRACK = SPELLINFO_INSTANT_SPELLCASTS_TO_TRACK or {
		-- MISC
		['Shoot']				= true,
