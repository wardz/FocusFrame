...
FocusFrame.cast.border:SetTexture("Interface\\AddOns\\FocusFrame\\libs\\UI-CastingBar-Border-Small.blp")
...
do
    local GetFocusCast = getglobal("FocusData").GetCast
